  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          'absolute inset-x-0 top-1 flex items-center justify-between gap-1',
        ...
        day: cn(
          'relative flex h-9 w-9 items-center justify-center p-0 text-center text-sm [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20',
